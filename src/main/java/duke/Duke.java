...
public class Duke {
    ...
    private static void printImportingMessage () {
        System.out.println ("Importing data from previous record" + System.lineSeparator () + "." + System.lineSeparator () + "." + System.lineSeparator () + "." + System.lineSeparator () + "." + System.lineSeparator () + "please wait :)");
        printLine ();
    }
    ...
    private static int printAddTaskMessage (int listSize, ArrayList<String> list, Task[] tasks) {
        ...
        System.out.println ("  [" + tasks[listSize].getType () + "]" + "[" + tasks[listSize].getStatusIcon () + "] " + list.get (listSize));
